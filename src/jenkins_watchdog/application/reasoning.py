    ...
    for build in builds:
        ...
        evidence = {
            **dict(build),
            ...
            "source_attribution": {
                "kind": build.get("source_kind"),
                "status": build.get("source_status"),
                "provider": build.get("source_provider"),
                "repository": build.get("repository"),
                "change_number": build.get("change_number"),
                "url": build.get("source_url") or build.get("change_url"),
                "branch": build.get("source_branch"),
                "commit_sha": build.get("source_commit_sha"),
                "title": build.get("source_title"),
                "state": build.get("source_state"),
                "profile_id": build.get("source_profile_id"),
                "profile_registered": build.get("source_profile_registered"),
                "allow_mr_comments": build.get("source_allow_mr_comments"),
                "resolution_method": build.get("source_resolution_method"),
                "reason": build.get("source_reason"),
            },
            "scm": {
                "provider": build.get("source_provider"),
                "repository": build.get("repository"),
